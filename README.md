...
```
kubectl crossplane install provider crossplane/provider-jet-hsdp:v0.1.0
```

You can see the API reference [here](https://doc.crds.dev/github.com/crossplane-contrib/provider-jet-hsdp).
